...
function resolve(value) {
    ...
    setTimeout(function callFulfilledCallback() {
        ...
        callFinallyCallbacks.call(this)
    })
}
...
function rejectPromise(reason) {
    ...
    */
    ...
    setTimeout(function callRejectedCallback() {
        ...
        } else if (!this.__finallyCallbacks.length){//in case console error multiple times
...
function callFinallyCallbacks() {
    this.__finallyCallbacks.forEach(function callback(finallyCallback) {
        finallyCallback()
    })
}
